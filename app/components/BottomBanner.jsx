    ...
    >
      <div className="flex items-center mx-auto">
        <p className="flex items-center text-sm font-normal text-gray-500">
          <span
            className="inline-flex p-1 me-3 bg-gray-200 rounded-full w-6 h-6 items-center justify-center"
          >
            <svg
          ...
          <span>
            Start Your Ecommerce Journey Today with 20% Off{" "}
            <a
              href=""
              className="flex items-center ms-0 text-sm font-medium text-yellow-500 md:ms-1 md:inline-flex hover:underline"
            >
              Get 20% Off{" "}
              <svg
