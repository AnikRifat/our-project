...
const Navbar = () => { 
  const { userId } = auth();
  return (
    <section className="sticky top-0 z-50 bg-gray-50">
      <div className="sm:px-2 mx-auto max-w-screen-xl lg:px-6">
  ...
  <>
    ...
    <Link
      href="/sign-up"
      className="text-black bg-gradient-to-br from-yellow-300 to-yellow-400 hover:bg-gradient-to-r focus:ring-4 focus:outline-none focus:ring-yellow-200  shadow-lg shadow-yellow-400/40 rounded-lg font-medium text-sm px-4 py-2 md:px-5 md:py-2.5"
    >
      Sign up
    </Link>
  </>
              ...
              >
                <li>
                  ...
                  <div
                    ...
                    className="absolute z-10 grid hidden w-auto grid-cols-2 text-sm bg-white border border-gray-100 rounded-lg shadow-md md:grid-cols-3"
                  >
                ...
                <li>
                  <Link
                    href="/pricing"
                    className="block py-2 px-3 text-gray-900 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-600 md:p-0"
                  >
                    Pricing
                  </Link>
                </li>
