  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
    ...
    >
      ...
      <div className="flex flex-col mb-4 lg:mb-8 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          <Link
            href="/apply"
            className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-black from-yellow-400 to-yellow-300 bg-gradient-to-r hover:bg-gradient-to-l focus:ring-4 focus:ring-yellow-200 rounded-lg" rel="noreferrer"
          >
        <svg className="mr-2 -ml-1 w-7 h-7" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
          ...
          <Link
            href="/apply"
            className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-black rounded-lg border border-black  hover:text-white hover:border-gradient-to-r from-gray-900 to-gray-700 hover:bg-gradient-to-r focus:ring-4 focus:ring-gray-200 " rel="noreferrer"
          >
